let mongoose,Schema,bcrypt,jwt;_c66‍.x([["default",()=>_c66‍.o]]);_c66‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}],["Schema",["Schema"],function(v){Schema=v}]]);_c66‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);_c66‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
 //비밀번호를 데이터베이스에 저장할때
//안전하게 하기 위해 필요함
