let Joi,User,jwt;_8c5‍.x([["register",()=>register],["login",()=>login],["check",()=>check],["logout",()=>logout]]);_8c5‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);_8c5‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_8c5‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]); //객체를 수월하게 검증하기 위한 라이브러리
