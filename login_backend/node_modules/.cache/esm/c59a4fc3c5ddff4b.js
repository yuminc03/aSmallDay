let Post,mongoose,Joi,sanitizeHtml;_c5d‍.x([["getPostById",()=>getPostById],["write",()=>write],["list",()=>list],["read",()=>read],["remove",()=>remove],["update",()=>update],["checkOwnPost",()=>checkOwnPost]]);_c5d‍.w("../../models/post",[["default",["Post"],function(v){Post=v}]]);_c5d‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_c5d‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);_c5d‍.w("sanitize-html",[["default",["sanitizeHtml"],function(v){sanitizeHtml=v}]]);


//HTML을 작성하고 보여 주어야 하는 서비스에서 유용함
